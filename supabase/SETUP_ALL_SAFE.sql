-- ============================================================================
-- AdProof — SAFE full setup. Paste this ENTIRE file into the Supabase SQL
-- editor (of the project your app uses: clypkvuhwfsahofaqgel) and Run ONCE.
--
-- Difference from SETUP_ALL.sql: this version first drops the stale
-- `ad_breakdowns` table that was causing "column user_id does not exist"
-- (derived analytics only, rebuilt on next sync), and at the end creates the
-- `ad-creatives` storage bucket. Safe to re-run.
-- ============================================================================

-- [0] Clear the stale table that blocks setup (see supabase/FIX_ad_breakdowns.sql)
...
-- ============================================================================
-- [11] Storage bucket for creative uploads (migration 0006 sets the policies;
--      this creates the bucket itself). Private — the app serves signed URLs.
-- ============================================================================
